...
[![License](https://img.shields.io/github/license/Joouis/agent-maestro)](https://github.com/Joouis/agent-maestro/blob/HEAD/LICENSE) -->
...
3. **Development Resources**:
   - **API Documentation**: Complete reference in [`docs/roo-code/`](https://github.com/Joouis/agent-maestro/blob/HEAD/docs/roo-code/README.md)
...
This project is licensed under the terms specified in the [LICENSE](https://github.com/Joouis/agent-maestro/blob/HEAD/LICENSE) file.
